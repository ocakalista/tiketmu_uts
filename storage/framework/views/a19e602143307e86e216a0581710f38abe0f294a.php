...
<head>
    ...
    <!-- Favicon -->
    <link href="<?php echo e(asset('img/favicon.icon')); ?>" rel="icon">
            ...
            <div class="row">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="row pt-3 mx-0">
                        <?php $__currentLoopData = [['success','1234','Music'],['primary','123','Teater'],['secondary','123','Seminar'],['warning','1234','Pameran']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$bg,$num,$label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-3 px-0">
                            <div class="bg-<?php echo e($bg); ?> text-center p-4">
                                <h1 class="text-white" data-toggle="counter-up"><?php echo e($num); ?></h1>
                                <h6 class="text-uppercase text-white">Event<span class="d-block"><?php echo e($label); ?></span></h6>
                            </div>
                        </div>
        ...
        <div class="container py-5">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 pb-4">
                    <a class="concert position-relative d-block overflow-hidden mb-2" href="<?php echo e(url('event/detail/1')); ?>">
                        <img class="img-fluid" src="<?php echo e(asset('img/crsl.jpg')); ?>" alt="CRSL Event">
                ...
                <!-- Event 2 -->
                <div class="col-lg-4 col-md-6 pb-4">
                    <a class="concert position-relative d-block overflow-hidden mb-2" href="<?php echo e(url('event/detail/2')); ?>">
                        <img class="img-fluid" src="<?php echo e(asset('img/crsl.jpg')); ?>" alt="CRSL Event">
                        <div class="concert-text">
                            <h4 class="text-center text-black px-3">CRSL Land Festival</h4>
                            <div class="border-top w-100 mt-3">
                ...
                <!-- Event 3 -->
                <div class="col-lg-4 col-md-6 pb-4">
                    <a class="concert position-relative d-block overflow-hidden mb-2" href="<?php echo e(url('event/detail/3')); ?>">
                        <img class="img-fluid" src="<?php echo e(asset('img/crsl.jpg')); ?>" alt="CRSL Event">
                        <div class="concert-text">
                            <h4 class="text-center text-black px-3">CRSL Land Festival</h4>
                            <div class="border-top w-100 mt-3">
                    ...
                    <div class="owl-carousel testimonial-carousel">
                        <div class="bg-light p-5">
                            ...
                            <div class="d-flex flex-shrink-0 align-items-center mt-4">
                                <img class="img-fluid mr-4" src="<?php echo e(asset('img/testimonial.jpg')); ?>" alt="">
                                <div>
                                    <h5>Rosa Kalista</h5>
                        ...
                        <form method="POST" action="<?php echo e(route('contact.send')); ?>">
                            ...
                            <div class="row">
                                <div class="col-6 form-group">
                                    <input type="text" name="name" value="<?php echo e(old('name')); ?>" class="form-control border-top-0 border-right-0 border-left-0 p-0" placeholder="Your Name" required>
                                </div>
                                <div class="col-6 form-group">
                                    <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="form-control border-top-0 border-right-0 border-left-0 p-0" placeholder="Your Email" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <input type="text" name="subject" value="<?php echo e(old('subject')); ?>" class="form-control border-top-0 border-right-0 border-left-0 p-0" placeholder="Subject" required>
                            </div>
                            <div class="form-group">
                                <textarea name="message" rows="5" class="form-control border-top-0 border-right-0 border-left-0 p-0" placeholder="Message" required><?php echo e(old('message')); ?></textarea>
                            </div>
                            <div>
...
</html><?php /**PATH /Users/macbookpro/Documents/Pemrograman/php/pemrog-web/tiketmu_uts/resources/views/index.blade.php ENDPATH**/ ?>